...
export default function GlobalFilters({ filters, symbols, models, onChange }: GlobalFiltersProps) {
  return (
    <div className="glass-card p-4 space-y-3">
      <p className="text-[11px] text-slate-500 tracking-wide">These filters apply to all sections below — chart, signals, trades, and leaderboard.</p>
          ...
          <div className="flex gap-2">
            {timeRanges.map((range) => (
              <button
                ...
                className={`px-3 py-2 rounded-md text-xs font-semibold border transition ${filters.timeRange === range
